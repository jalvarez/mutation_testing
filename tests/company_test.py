...
def test_employee_added(company):
    previous_employees_num = company.number_of_employees()
    company.add_employee(Employee("123", "Dave", 100_000.00))
    assert previous_employees_num + 1 == company.number_of_employees()

    company.add_employee(Employee("456", "Bob", 50_000.00))
    assert previous_employees_num + 2 == company.number_of_employees()
